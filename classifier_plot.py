...
class ControllBar:
    def __init__(self, root, controller):
        ...
        Tk.Radiobutton(
            classifier_group,
            text="Decision tree",
            variable=controller.classifier,
            value=0,
        ).pack(anchor=Tk.W)
        Tk.Radiobutton(
            classifier_group, text="SVM", variable=controller.classifier, value=1
        ).pack(anchor=Tk.W)
        Tk.Radiobutton(
            classifier_group,
            text="Naive Bayes",
        ...
        Tk.Radiobutton(
            classifier_group, text="k-NN", variable=controller.classifier, value=3
        ).pack(anchor=Tk.W)
        classifier_group.pack(side=Tk.LEFT)

        kernel_group = Tk.Frame(fm)
        Tk.Radiobutton(
            kernel_group, text="Linear", variable=controller.kernel, value=0
        ).pack(anchor=Tk.W)
        Tk.Radiobutton(
            kernel_group, text="RBF", variable=controller.kernel, value=1
        ).pack(anchor=Tk.W)
        Tk.Radiobutton(
            kernel_group, text="Poly", variable=controller.kernel, value=2
        ).pack(anchor=Tk.W)
        ...
        Tk.Radiobutton(
            cmap_group, text="Hyperplanes", variable=controller.surface_type, value=0
        ).pack(anchor=Tk.W)
        Tk.Radiobutton(
            cmap_group, text="Surface", variable=controller.surface_type, value=1
        ).pack(anchor=Tk.W)
        ...
        Tk.Button(fm, text="Clear", command=controller.clear_data).pack(side=Tk.LEFT)
